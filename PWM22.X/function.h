...
void init_ADC()
{
   ...
   ANSELB=0x073F;        // Select AN0,AN1,AN2,AN3,AN4,AN5,AN8,AN9and AN10 channel as analog input
   ...
   AD1CON4 = 0x0000;
   AD1CSSH = 0x0000;
   AD1CSSL = 0x073F;     // Select AN0,AN1,AN2,AN3,AN4,AN5,AN8,AN9and AN10 for scanning      
   AD1CHS0bits.CH0SA = 0; 
   AD1CHS0bits.CH0NA = 0; 
   AD1CON1bits.ADON = 1;
